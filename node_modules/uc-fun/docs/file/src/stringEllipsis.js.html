...
<head>
  ...
  <title data-ice="title">src/stringEllipsis.js | uc-fun</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/stringEllipsis.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import stringRealLen from &apos;./stringRealLen&apos;;
